...
async function main() {
  ...
  await prisma.role.upsert({ where: { name: RoleName.GERENTE }, update: {}, create: { name: RoleName.GERENTE } });
  await prisma.role.upsert({ where: { name: RoleName.CLIENTE }, update: {}, create: { name: RoleName.CLIENTE } });
